  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <a href="https://github.com/priyanshjhaa/Axiom">
        <img src="assets/Screenshots/Axiom.png" alt="Axiom preview" />
      </a>
    </td>
    <td width="50%" valign="top">
      ...
      <a href="https://github.com/priyanshjhaa/Cinematch25">
        <img src="assets/Screenshots/Cinematch.png" alt="Cinematch preview" />
      </a>
    </td>
  </tr>
</table>
...
```mermaid
flowchart LR
    A["Understand the real problem"] --> B["Model the system"]
    B --> C["Build the smallest useful version"]
    C --> D["Observe real behavior"]
    D --> E["Make reliability a feature"]
    E --> A
```
...
![Footer](https://capsule-render.vercel.app/api?type=waving&color=0:22d3ee,55:1d4ed8,100:111827&height=110&section=footer)
